...
void MADGWICK_AHRS::get_euler_quaternion(float dt_s, float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float &angle_x, float &angle_y, float &angle_z) {
	m_dt_s = dt_s;
